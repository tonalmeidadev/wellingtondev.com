  ...
  return (
    <div className="h-screen md:pl-60">
      ...
      <div className="m-auto flex max-w-5xl flex-col-reverse gap-40 px-8 py-8 xs:px-16 md:flex-col">
        <header className="g ap-8 grid grid-cols-1 items-center md:grid-cols-[auto_auto] md:gap-0 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-8">
            ...
            <span className="text-[11px] uppercase text-neutral-400 sm:hidden">
